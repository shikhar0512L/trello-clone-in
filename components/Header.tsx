...
<div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-orange-500 to-[#0055D1] rounded-md filter blur-3xl opacity-50 -z-50"/>
...
<form className="flex items-center space-x-5 bg-white rounded-md p-2 shadow-md flex-1 md:flex-initial">
    ...
    {/* Avatar */}
    <Avatar name='shikhar singh' round color="#0055D1" size='50'/>
</div>
      </div>
