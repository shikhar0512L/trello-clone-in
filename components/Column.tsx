  ...
  return (
    <Draggable draggableId={id} index={index}>
        {(provided)=>(
            ...
            >
{/* render droppable todos into columns */}
...
<div className="flex items-end justify-end p-2"><button onClick={handleAddTodo} className="text-green-500 hover:text-green-600">
